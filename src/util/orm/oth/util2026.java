...
//import static cn.dev33.satoken.util.SaFoxUtil.encodeUrl;
import static java.time.LocalTime.now;
import static org.apache.commons.codec.net.URLCodec.encodeUrl;
import static util.orm.oth.JarClassScanner.getCurrentJarPath;
import static util.orm.oth.Util2025.encodeJson;
// static util.algo.EncodeUtil.encodeUrl;
...
//    }
    ...
    private static void appendFile(String s, String s1) {
    }
...
//    }
    ...
    public static <T> void scanAllClassByClsesDir(boolean testUnitMode,Consumer<T> csmr) {
        System.out.println("scannAllcls at " + now());
        try {
            // 获取 classes 目录
...
//    }
    ...
    public static void setcookie(String name, String val, HttpExchange exchange) {
        ...
        String expiresDate = new SimpleDateFormat("EEE, dd MMM yyyy HH:mm:ss 'GMT'")
    ...
    private static String encodeUrl(String val) {
        return  "";
    }
