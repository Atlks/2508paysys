...
import static util.uti.enttMngrs.RdsEnttMngr.objectMapper;
@Data
public class IniEnttMngr  extends EntityManagerBase implements EntityManager {

    private String dbDir="";

    public IniEnttMngr(String db_dir) {
        this.dbDir=db_dir;
    }
...
return userList;
    ...
    public void persist(Object entity) {
        ...
        try {
            ...
            String dir=dbDir+"/"+collectionName+"/";
            String file=dir+idValue+".json";
            write(file,encodeJson(entity));
