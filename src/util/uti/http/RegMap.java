...
// static util.serverless.ApiGateway.*;

/**
 * all depre jdk sver ,bcs uplod cant...   and conn cant auto close
...
//    private static void registerMapping(String path, Method m, HttpExchange ctx) {
//    }
...
//    public static <T> void createContext(String path, RequestHandler<T, Object> fun) {
//        registerMapping(path, fun, ProcessContext.httpServer);
//    }

    //not trans context,just read in anno

//    public static <DtoType> void registerMapping(String path, RequestHandler<DtoType, Object> fun, RegMapContext rmCtx) {
//
...
//                    DtoType dto = (DtoType) util.msc.HttpUti.toDto(mp, lambdaMethodParamFirstType);
//                    valdt(dto);
...
//
//            //def output json
//            if(rmCtx.produces.equals(MediaType.TEXT_HTML))
...
//    }
    ...
    private static <DtoType> boolean isMapClass(Class<DtoType> lambdaMethodParamFirstType) {
        return Map.class.isAssignableFrom(lambdaMethodParamFirstType);
    }

    public static <DtoType> void registerMapping(String path, Class<DtoType> dtoCls, RequestHandler<DtoType, Object> fun) {
        Javalin javalinApp = ProcessContext.appJvl;
        Handler handler = ctx -> {
...
//     * @param <T>
//     */
//    public static <T> void registerMapping(String path, RequestHandler<T, Object> fun, HttpServer httpServer) {
//        //get raw fun(dto    name,type .to aop log
//
//
