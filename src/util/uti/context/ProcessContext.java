...
public  static HttpServer httpServer;
    ...
    public      static   Set<String> NO_AUTH_PATHS=new HashSet<>();
...
//    ProcessContext.httpContexts
    ...
    public static Map<String, List<Annotation>> authMapCfg=new ConcurrentHashMap<>();

    public static ExceptionHandler<Exception> excptnHdlrInWeb;
    public static Authenticator authenticator;
    public static ExceptionHandler<Exception> excptnHdlr;

    public static Map<FunType, RequestHandler<Map,Object>> funMap4httpHdlr =new ConcurrentHashMap<>();

    // #procs ctx.java
    public static RequestHandler<Dtoo, Object> fun_userAdd;
    public static RequestHandler<Dtoo, Object> fun_BlsAdd;
