...
import static util.uti.context.ThreadContext.currEttyMngr;
...
public class JpaUti {
    ...
    public static void persist(Object alice,EntityManager em) {
        System.out.println("fun persist");
      em.persist(alice);
      em.flush();
        System.out.println("endfun persist");
    ...
    public static <T> T find(Class<T> entt, Object id) {
        ...
        if (t == null) {
            throw new EntityNotFoundException("dt not exist ,id="+id);
        }
