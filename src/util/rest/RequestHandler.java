...
import static util.uti.Uti.getDeclaredMethod;
 ...
 */
@FunctionalInterface
public interface RequestHandler<T, R> extends Serializable {
     ...
     */
    default <V> RequestHandler<V, R> compose(RequestHandler<? super V, ? extends T> before) {
     ...
     */
    default <V> RequestHandler<T, V> andThen(RequestHandler<? super R, ? extends V> after) {
     ...
     */
    static <T> RequestHandler<T, T> identity() {
        return t -> t;
    }
