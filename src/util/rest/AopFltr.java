...
import static util.rest.AopFuns.*;
...
public class AopFltr extends Filter {
    ...
    public static void callInTransaction(HttpExchange exchange, Chain chain) throws Throwable {
        ...
        TxMng.callInTransaction(entityManagerObjectRequestHandler);
    }
}
