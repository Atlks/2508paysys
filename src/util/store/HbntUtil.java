...
import util.excptn.findByIdExptn_CantFindData;
...
import static util.store.Pagging.getstartPosition;
import static util.store.dbutil.*;
// static util.tx.dbutil.*;

/**
 * 25.729 depred  。。use jpa api
 */
//ormUtilHbnt
...
//        sessionFactory = configuration.buildSessionFactory(serviceRegistry);
    ...
    public static SessionFactory getSessionFactory(String jdbcUrl, List<Class> li) throws SQLException {
        ...
        properties.put(Environment.DIALECT, getDialect(jdbcUrl));
...
//        }
    ...
    private static Object getDialect(String jdbcUrl) {

       if(jdbcUrl.contains("jdbc:postgresql:"))
            return "org.hibernate.dialect.PostgreSQLDialect";
     //   System.out.println(org.hibernate.dialect.PostgreSQLDialect);
        ...
        {
           // System.out.println(org.hibernate.dialect.SQLServerDialect);
